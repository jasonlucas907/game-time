...
function gameStart()  {
  ...
  lives = 3;
  gameMusic();
  setTimeout(() => {getReady(); }, 4000);
  setTimeout(() => {buildInvadersRow1(); }, 6000);
  setTimeout(() => {buildInvadersRow2(); }, 6000);
  setTimeout(() => {buildInvadersRow3(); }, 6000);
}
