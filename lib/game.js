...
// gameStartCheck: 0 = gameStart can function.  0 = instuction video can function.  2 = game rest can function
...
function gameStart()  {
  ...
  setTimeout(() => {gameStartCheck = 2 }, 11000);
...
// add robbie intro video delay and remove
function introVideo() {
  $(".game-container").append(`
