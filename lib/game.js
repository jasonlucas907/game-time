...
function installGamePackage()  {
  ...
  setTimeout(() => {enableResetButton(); }, 11000);
...
function instructionVideo() {
  $(".game-container").append(`
    <section class='intro-video-container video-container'>
      <video poster="assests/zoe-part2.mp4" class='intro-video' id="bgvid" playsinline autoplay>
          <source src="assests/zoe-part2.mp4" type="video/webm">
          <source src="assests/zoe-part2.mp4" type="video/mp4">
      </video>
    </section
    `);
